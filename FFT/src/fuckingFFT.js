...
var dft = function(vector) {
  ...
  for (var k = 0; k < 60; k++) {
    ...
    for (var i = 0; i < N; i++) {
      ...
      var term = complexMultiply([vector[i], 0], exp); //Complex mult of the signal with the exponential term.
    ...
    for (var len = 2; len <= N; len += len) {
      for (var i = 0; i < len / 2; i++) {
        ...
        for (var j = 0; j < N / len; j++) {
          ...
          vector[j * len + i + len / 2] = complexSubtract(vector[j * len + i], t);
